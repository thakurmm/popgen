...
'''
	...
	test_filename = the test file (or the chrom_try) file generated by generate_test_set.py
	all_admixture_filename = admixture output .Q file across ALL chromosomes (chr1, chr2 .... )
	admixture_filename = admixture output .Q file for a specific chromosome (e.g. chr22)
